  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        <button
          onClick={handleAdd}
          className="bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition w-full sm:w-auto"
        >
      ...
      {showForm && (
        <DynamicForm
          ...
          fields={[
            { name: "name", label: "Tên bậc tài khoản", type: "text", required: true },
            { name: "pointLimit", label: "Hạn mức điểm", type: "number", required: true },
          ]}
