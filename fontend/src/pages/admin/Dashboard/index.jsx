...
const dashboardCards = [
  ...
  { name: "Khách hàng", Icon: FaUsers, color: "bg-yellow-400", path: "/quan-tri/quan-ly-khach-hang" },
  ...
  { name: "Nhân viên", Icon: FaUser, color: "bg-pink-400", path: "/quan-tri/quan-ly-nhan-vien" },
  { name: "Tài khoản", Icon: FaKey, color: "bg-green-600", path: "/quan-tri/quan-ly-tai-khoan" },
  { name: "Kho, cửa hàng", Icon: FaWarehouse, color: "bg-purple-700", path: "/quan-tri/quan-ly-kho" },
];
