  ...
  const menuItems = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: "Quản lý màn hình", path: "/quan-tri/quan-ly-man-hinh" },
        { label: "Quản lý bộ nhớ", path: "/quan-tri/quan-ly-bo-nho" },
        { label: "Quản lý kết nối", path: "/quan-tri/quan-ly-ket-noi" },
        { label: "Quản lý camera trước", path: "/quan-tri/quan-ly-camera-truoc" },
        { label: "Quản lý camera sau", path: "/quan-tri/quan-ly-camera-sau" },
        { label: "Quản lý hệ điều hành", path: "/quan-tri/quan-ly-he-dieu-hanh" },
