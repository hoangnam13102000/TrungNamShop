...
import {
  ...
  useUpdateRearCamera,
  useDeleteRearCamera,
} from "../../../../api/product/rearCamera";

export default memo(function AdminRearCameraPage() {
  const { data: rearCameras = [], isLoading, refetch } = useRearCameras();

  const createMutation = useCreateRearCamera();
  const updateMutation = useUpdateRearCamera();
  const deleteMutation = useDeleteRearCamera();
